						...
						<tbody>
							...
							<tr>
								...
								<td><input class="common-text required" id="title"
									name="itemName" size="50" placeholder="${item.itemName}" type="text"></td>
							</tr>
							<tr>
								<th>商品价格：</th>
								<td><input class="common-text" name="price" size="50"
									type="text" placeholder="${item.price}"></td>
							</tr>
							<tr>
								<th>商品库存：</th>
								<td><input class="common-text" name=count size="50"
									type="text" placeholder="${item.count}"></td>
							</tr>
							<tr>
								<th>商品缩略图：</th>
							...
							<tr>
								...
								<td><textarea name="itemDesc" class="common-textarea"
										id="content" cols="30" style="width: 98%;" rows="10">${item.itemDesc}</textarea></td>
							</tr>
							<tr>
								<th></th>
